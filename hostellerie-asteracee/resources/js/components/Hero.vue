<template>
    <div class="hero shadow-md shadow-gray-700">
        <div class="media">
            ...
            <div class="video">
                <iframe width="650" height="365" src="https://www.youtube.com/embed/-B7VhYjd6xc"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; z-index: 1;"></iframe>
                <p>{{ hero.text }}</p>
            </div>
