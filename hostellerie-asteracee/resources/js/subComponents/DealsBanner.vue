<template>
    ...
    <div
        class="h-450 w-3/4 sm:h-380 sm:w-4/6 md:h-400 md:w-4/6 lg:h-330 lg:w-4/5 xl:w-4/6 xl:h-48 bg-[#272023] border-t-4 border-t-[#E6B34B] mb-10 mx-auto shadow-md shadow-gray-700 relative">

        <!-- Rectangle + border qui dépasse en bas à gauche du deals banner - à partir de l'iphone SE-->
        <div class="w-40 h-4  bg-[#272023] border-t-4 border-t-[#E6B34B] text-white block absolute bottom-0 sm:top-24 sm:ml-2 xl:hidden"></div>
        <div class="w-20 h-10 sm:bg-[#E6B34B] absolute bottom-0 sm:top-24 sm:ml-2 xl:hidden"></div>
        <!-- Rectangle + border qui dépasse en bas à gauche du deals banner xl - à partir de 1280px-->
        <div class="xl:w-40 xl:h-10  xl:bg-[#272023] xl:border-t-4 xl:border-t-[#E6B34B] text-white block absolute xl:bottom-0 ml-2"></div>
        <div class="xl:w-20 xl:h-10 xl:bg-[#E6B34B] absolute xl:bottom-0 ml-2"></div>


        <div class="xl:flex xl:justify-around h-full mt-7 xl:mt-0 2xl:justify-around">
            <!-- Content -->
            <div class="flex flex-col text-3xl text-[#E6B34B] font-bold sm:mb-16 xl:mt-8">
